            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-2">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        <x-application-logo class="block h-9 w-auto text-indigo-600 dark:text-indigo-400" />
                        <span class="font-bold text-lg tracking-tight text-gray-900 dark:text-white hidden sm:block">Server Sentinel</span>
                    </a>
                </div>
