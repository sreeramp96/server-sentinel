                                                    ...
                                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors
                                                        ...
                                                        {{-- Site name + paused badge + public link --}}
                                                            ...
                                                            <div class="text-xs text-gray-400 mt-0.5">
                                                                <a href="{{ $website->url }}" target="_blank" class="hover:text-indigo-500 transition-colors">
                                                                    {{ $website->url }}
                                                                </a>
                                                                            </div>
                                                                        ...
                                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                                            <div x-data="{ open: false }" class="relative">
                                                                                ...
                                                                                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                                                                    ...
                                                                                    <form method="POST" action="{{ route('websites.toggleMonitoring', $website) }}">
                                                                                        @csrf @method('PATCH')
                                                                                        <button type="submit"
            ...
            @foreach($websites as $website)
                <div
                    ...
                    <div class="p-6">
                        ...
                        @if(!$website->is_monitoring)
                            <div class="flex items-center justify-center h-24 text-sm text-amber-600 dark:text-amber-400 border border-dashed border-amber-200 dark:border-amber-800 rounded-lg bg-amber-50 dark:bg-amber-900/10">
